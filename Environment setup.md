...
2. Те, у кого ConEmu уже установлен, скачайте просто файл conemu_settings.xml из репозитория и импортируйте его в ваш ConEmu через settings - Import (кнопка внизу).

...
Если эта команда отстутствует или не сработала: можно попробовать выполнить
```
...
#### Первый способ (есть информация, что работает не у всех, используйте пока альтернативный)
1. Выполняем команду
`iex "& { $(irm https://aka.ms/install-powershell.ps1) } -UseMSI -AddToPath"`

...
> Live Share Audio вызывает проблемы на некоторых системных конфигурациях, подробнее см. troubleshooting-гайд.
...
> В случае проблем с установкой см. также Troubleshooting-гайд.
...
> В случае проблем с авторизацией см. Troubleshooting-гайд
